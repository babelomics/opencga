...
public class DiseasePanel {
    ...
    public DiseasePanel(long id, String name, int version) {
        this.id = id;
        this.name = name;
        this.version = version;
    }

    public DiseasePanel(long id, String name, int release, int version, String author, SourcePanel source, String description,
